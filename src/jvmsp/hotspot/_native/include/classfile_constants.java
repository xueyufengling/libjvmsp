...
public class classfile_constants
{
	...
	public static final byte JVM_CONSTANT_Utf8 = (byte) vm_constant.find_int("JVM_CONSTANT_Utf8");
	public static final byte JVM_CONSTANT_Unicode = (byte) vm_constant.find_int("JVM_CONSTANT_Unicode");
	public static final byte JVM_CONSTANT_Integer = (byte) vm_constant.find_int("JVM_CONSTANT_Integer");
	public static final byte JVM_CONSTANT_Float = (byte) vm_constant.find_int("JVM_CONSTANT_Float");
	public static final byte JVM_CONSTANT_Long = (byte) vm_constant.find_int("JVM_CONSTANT_Long");
	public static final byte JVM_CONSTANT_Double = (byte) vm_constant.find_int("JVM_CONSTANT_Double");
	public static final byte JVM_CONSTANT_Class = (byte) vm_constant.find_int("JVM_CONSTANT_Class");
	public static final byte JVM_CONSTANT_String = (byte) vm_constant.find_int("JVM_CONSTANT_String");
	public static final byte JVM_CONSTANT_Fieldref = (byte) vm_constant.find_int("JVM_CONSTANT_Fieldref");
	public static final byte JVM_CONSTANT_Methodref = (byte) vm_constant.find_int("JVM_CONSTANT_Methodref");
	public static final byte JVM_CONSTANT_InterfaceMethodref = (byte) vm_constant.find_int("JVM_CONSTANT_InterfaceMethodref");
	public static final byte JVM_CONSTANT_NameAndType = (byte) vm_constant.find_int("JVM_CONSTANT_NameAndType");
	public static final byte JVM_CONSTANT_MethodHandle = (byte) vm_constant.find_int("JVM_CONSTANT_MethodHandle");
	public static final byte JVM_CONSTANT_MethodType = (byte) vm_constant.find_int("JVM_CONSTANT_MethodType");
	public static final byte JVM_CONSTANT_Dynamic = (byte) vm_constant.find_int("JVM_CONSTANT_Dynamic");
	public static final byte JVM_CONSTANT_InvokeDynamic = (byte) vm_constant.find_int("JVM_CONSTANT_InvokeDynamic");
	public static final byte JVM_CONSTANT_Module = (byte) vm_constant.find_int("JVM_CONSTANT_Module");
	public static final byte JVM_CONSTANT_Package = (byte) vm_constant.find_int("JVM_CONSTANT_Package");
	public static final byte JVM_CONSTANT_ExternalMax = (byte) vm_constant.find_int("JVM_CONSTANT_ExternalMax");
