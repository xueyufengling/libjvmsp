...
public class vm_constant
{
	...
	public static final int JVM_CONSTANT_Utf8 = find_int("JVM_CONSTANT_Utf8");
	public static final int JVM_CONSTANT_Unicode = find_int("JVM_CONSTANT_Unicode");
	public static final int JVM_CONSTANT_Integer = find_int("JVM_CONSTANT_Integer");
	public static final int JVM_CONSTANT_Float = find_int("JVM_CONSTANT_Float");
	public static final int JVM_CONSTANT_Long = find_int("JVM_CONSTANT_Long");
	public static final int JVM_CONSTANT_Double = find_int("JVM_CONSTANT_Double");
	public static final int JVM_CONSTANT_Class = find_int("JVM_CONSTANT_Class");
	public static final int JVM_CONSTANT_String = find_int("JVM_CONSTANT_String");
	public static final int JVM_CONSTANT_Fieldref = find_int("JVM_CONSTANT_Fieldref");
	public static final int JVM_CONSTANT_Methodref = find_int("JVM_CONSTANT_Methodref");
	public static final int JVM_CONSTANT_InterfaceMethodref = find_int("JVM_CONSTANT_InterfaceMethodref");
	public static final int JVM_CONSTANT_NameAndType = find_int("JVM_CONSTANT_NameAndType");
	public static final int JVM_CONSTANT_MethodHandle = find_int("JVM_CONSTANT_MethodHandle");
	public static final int JVM_CONSTANT_MethodType = find_int("JVM_CONSTANT_MethodType");
	public static final int JVM_CONSTANT_Dynamic = find_int("JVM_CONSTANT_Dynamic");
	public static final int JVM_CONSTANT_InvokeDynamic = find_int("JVM_CONSTANT_InvokeDynamic");
	public static final int JVM_CONSTANT_Module = find_int("JVM_CONSTANT_Module");
	public static final int JVM_CONSTANT_Package = find_int("JVM_CONSTANT_Package");
	public static final int JVM_CONSTANT_ExternalMax = find_int("JVM_CONSTANT_ExternalMax");
	public static final int JVM_CONSTANT_Invalid = find_int("JVM_CONSTANT_Invalid");
	public static final int JVM_CONSTANT_InternalMin = find_int("JVM_CONSTANT_InternalMin");
	public static final int JVM_CONSTANT_UnresolvedClass = find_int("JVM_CONSTANT_UnresolvedClass");
	public static final int JVM_CONSTANT_ClassIndex = find_int("JVM_CONSTANT_ClassIndex");
	public static final int JVM_CONSTANT_StringIndex = find_int("JVM_CONSTANT_StringIndex");
	public static final int JVM_CONSTANT_UnresolvedClassInError = find_int("JVM_CONSTANT_UnresolvedClassInError");
	public static final int JVM_CONSTANT_MethodHandleInError = find_int("JVM_CONSTANT_MethodHandleInError");
	public static final int JVM_CONSTANT_MethodTypeInError = find_int("JVM_CONSTANT_MethodTypeInError");
	public static final int JVM_CONSTANT_DynamicInError = find_int("JVM_CONSTANT_DynamicInError");
	public static final int JVM_CONSTANT_InternalMax = find_int("JVM_CONSTANT_InternalMax");
